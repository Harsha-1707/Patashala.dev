...
export const WhatYouBuild = () => {
  ...
  return (
    <section id="projects" className="py-12 md:py-20 lg:py-24 bg-gradient-to-br from-brand-neutral-light via-purple-50 to-teal-50 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          <motion.div className="bg-white rounded-2xl md:rounded-3xl p-4 md:p-6 lg:p-8 mb-6 md:mb-8 inline-block shadow-lg">
            <motion.img 
              src={learningIcons} 
        ...
        >
          {projects.map((project, index) => (
            <motion.div
              ...
              className="bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl p-6 md:p-8 shadow-md border-l-4 cursor-pointer group relative"
              style={{ 
            ...
            >
              {/* Floating icon */}
              <motion.div
                className="absolute -top-4 -right-4 md:-top-6 md:-right-6 text-4xl md:text-5xl lg:text-6xl"
                initial={{ rotate: 0 }}
                whileHover={{ 
                  rotate: 360,
                  scale: 1.2,
              ...
              <motion.h3 
                className="text-lg md:text-xl lg:text-2xl mb-3 md:mb-4 pr-10 md:pr-12" 
